...
This is a fork of the [original Accel-Sim repo](https://github.com/accel-sim/accel-sim-framework) that add support for GCN3-based AMD GPU simulation
that runs on traces generated by a [modified MGPUSim simulator](https://github.com/William-An/MGPUSim-Accel-Sim). Currently, the following 
testcases from [MGPUSim benchmarks](https://github.com/William-An/MGPUSim-Accel-Sim/tree/main/benchmarks) can be run:

1. `aes`
2. `fir`
3. `kmeans`
4. `fastwalshtransform`
