...
//        }
        stage('correlate-ubench'){
            steps{
                ...
                rsync --delete -r ./util/plotting/correl-html/ tgrogers@dynamo:~/website/accel-sim/latest-correl
                echo "Correlation Report at: https://engineering.purdue.edu/tgrogers/accel-sim/latest-correl"
                '''
            }
        }
    }
