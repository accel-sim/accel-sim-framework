    ...
    stages {
        ...
        stage('nightly-trace'){
            steps{
                ...
                source ./env-setup/11.0_env_setup.sh
                source ./gpu-simulator/setup_environment.sh
                ./util/job_launching/run_simulations.py -B rodinia-3.1,GPU_Microbenchmark,sdk-4.2-scaled ,parboil,polybench,cutlass_5_trace,Deepbench_nvidia -C QV100 -T ~/../common/accel-sim/traces/tesla-v100/latest/ -N nightly-$$ -M 70G
