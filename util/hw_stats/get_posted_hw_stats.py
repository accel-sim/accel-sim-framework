...
parser = OptionParser()
parser.add_option("-c", "--cards", dest="cards", default="all",
                  help="Comma seperated list of cards to download. Available cards: {0}".format(cards_availible))
