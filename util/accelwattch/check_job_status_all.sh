...
${root_dir}/util/accelwattch/check_job_status.sh volta_sass_sim
echo "Job status for volta_sass_hw:"
${root_dir}/util/accelwattch/check_job_status.sh volta_sass_hw
echo "Job status for volta_sass_hybrid:"
${root_dir}/util/accelwattch/check_job_status.sh volta_sass_hybrid
echo "Job status for volta_ptx_sim:"
${root_dir}/util/accelwattch/check_job_status.sh volta_ptx_sim