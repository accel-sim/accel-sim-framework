...
#time ./run_hw_trace.py -B GPU_Microbenchmark -D 0 2>&1 | tee ubench.out
...
time ./run_hw_trace.py -B rodinia-3.1 -D 0 2>&1 | tee rodinia.out
mv ../../hw_run/traces/device-0/ ../../hw_run/traces/rodinia-3.1
ssh tgrogers-raid.ecn.purdue.edu mkdir -p /scratch/tgrogers-disk01/a/$USER/tmp-turing-traces
...
time ./run_hw_trace.py -B parboil -D 0 2>&1 | tee parboil.out 
mv ../../hw_run/traces/device-0/ ../../hw_run/traces/parboil
ssh tgrogers-raid.ecn.purdue.edu mkdir -p /scratch/tgrogers-disk01/a/$USER/tmp-turing-traces
...
time ./run_hw_trace.py -B polybench -D 0 2>&1 | tee polybench.out
mv ../../hw_run/traces/device-0/ ../../hw_run/traces/polybench
ssh tgrogers-raid.ecn.purdue.edu mkdir -p /scratch/tgrogers-disk01/a/$USER/tmp-turing-traces
...
time ./run_hw_trace.py -B cutlass_5_trace -D 0 2>&1 | tee cutlass.out
mv ../../hw_run/traces/device-0/ ../../hw_run/traces/cutlass_5_trace
ssh tgrogers-raid.ecn.purdue.edu mkdir -p /scratch/tgrogers-disk01/a/$USER/tmp-turing-traces
...
time ./run_hw_trace.py -B Deepbench_nvidia_tencore,Deepbench_nvidia_normal -D 0 2>&1 | tee deepbench.out 
mv ../../hw_run/traces/device-0/ ../../hw_run/traces/Deepbench_nvidia
ssh tgrogers-raid.ecn.purdue.edu mkdir -p /scratch/tgrogers-disk01/a/$USER/tmp-turing-traces
